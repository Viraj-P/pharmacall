      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <nav className="flex md:hidden items-center space-x-1">
            ...
            <Link href="/analytics" className="px-3 py-1.5 text-sm font-medium text-[#f0ece6]/70 hover:text-[#f0ece6] rounded-md hover:bg-white/10 transition-colors">
              Analytics
            </Link>
            <Link href="/patients" className="px-3 py-1.5 text-sm font-medium text-[#f0ece6]/70 hover:text-[#f0ece6] rounded-md hover:bg-white/10 transition-colors">
              Patients
            </Link>
